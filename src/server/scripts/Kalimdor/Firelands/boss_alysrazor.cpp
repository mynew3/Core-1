...
enum Spells
{
    ...
    SPELL_MOLTEN_FEATHER_SCRIPT = 98734,
...
#define SPELL_BRUSHFIRE_AURA_DMG    RAID_MODE(98885, 100715, 100716, 100717)
#define SPELL_LAVA_SPEW_DMG         RAID_MODE(99336, 100725, 100726, 100727)
#define SPELL_INCENDIARY_CLOUD_DMG  RAID_MODE(99427, 100729, 100730, 100731)
#define SPELL_FIERY_TORNADO_DMG     RAID_MODE(99816, 100733, 100734, 100735)

enum Events
{
    EVENT_BERSERK = 1,
    EVENT_INCINDIARY_CLOUD,
    EVENT_BLAZING_POWER,
    EVENT_ROTATE,
    EVENT_FLIGHT,
    EVENT_IGNITION,
...
const Position centerPos = {-42.06f, -276.10f, 54.4f, 3.22f};
...
const Position broodmotherPos[6] =
{
    ...
    {-32.901f, -272.019f, 105.0f, 0.0f},
    {46.930f, -207.560f, 90.000f, 0.0f},
    
    {-44.463f, -285.802f, 105.0f, 0.0f},
    {-28.813f, -378.088f, 90.371f, 0.0f}
};
...
class npc_alysrazor_blazing_power : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_blazing_powerAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
                me->SetReactState(REACT_PASSIVE);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_blazing_powerAI(creature);
        }
};
...
class npc_alysrazor_incindiary_cloud : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_incindiary_cloudAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
                me->SetReactState(REACT_PASSIVE);
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_NON_ATTACKABLE);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_incindiary_cloudAI(creature);
        }
};
...
class npc_alysrazor_fiery_vortex : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_fiery_vortexAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_fiery_vortexAI(creature);
        }
};
...
class npc_alysrazor_fiery_tornado : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_fiery_tornadoAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
                me->SetReactState(REACT_PASSIVE);
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_NON_ATTACKABLE);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_fiery_tornadoAI(creature);
        }
};
...
class npc_alysrazor_blazing_talon_initiate : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_blazing_talon_initiateAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
                waypoint = 0;
                me->SetReactState(REACT_PASSIVE);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_blazing_talon_initiateAI(creature);
        }
};
...
class npc_alysrazor_brushfire : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_brushfireAI(Creature* creature) : ScriptedAI(creature) 
            {
                me->SetReactState(REACT_PASSIVE);
                started = false;
                needJump = false;
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_brushfireAI (creature);
        }
};
...
class npc_alysrazor_blazing_talon_clawshaper : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_blazing_talon_clawshaperAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
                instance = creature->GetInstanceScript();
                me->SetReactState(REACT_PASSIVE);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_blazing_talon_clawshaperAI(creature);
        }
};
...
class npc_alysrazor_blazing_broodmother : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_blazing_broodmotherAI(Creature* creature) : ScriptedAI(creature) 
            {
                me->SetReactState(REACT_PASSIVE);
            }
...
class npc_alysrazor_molten_egg : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_molten_eggAI(Creature* creature) : Scripted_NoMovementAI(creature) 
            { 
                started = false;
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_molten_eggAI (creature);
        }
};
...
class npc_alysrazor_voracious_hatchling : public CreatureScript // 53509
{
    public:
        ...
        {
            npc_alysrazor_voracious_hatchlingAI(Creature* creature) : ScriptedAI(creature) 
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_voracious_hatchlingAI (creature);
        }
};
...
class npc_alysrazor_plump_lava_worm : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_plump_lava_wormAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
                me->SetReactState(REACT_PASSIVE);
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_NON_ATTACKABLE);
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_plump_lava_wormAI(creature);
        }
};
...
class npc_alysrazor_molten_feather : public CreatureScript
{
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if (player->HasAura(SPELL_WINGS_OF_FLAME_AURA))
                return true;

            uint8 stacks = 0;
            if (Aura const* aur = player->GetAura(SPELL_MOLTEN_FEATHER))
                stacks = aur->GetStackAmount();

            if (stacks < 3)
                player->CastSpell(player, SPELL_MOLTEN_FEATHER, true);          
            
            player->SetPower(POWER_ALTERNATE_POWER, stacks + 1);

            if (stacks >= 2)
                player->CastSpell(player, SPELL_WINGS_OF_FLAME, true);
...
class npc_alysrazor_herald_of_the_burning_end : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_herald_of_the_burning_endAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
                me->SetReactState(REACT_PASSIVE);
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_NON_ATTACKABLE); 
            }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_herald_of_the_burning_endAI(creature);
        }
};
...
class npc_alysrazor_molten_meteor : public CreatureScript
{
    public:
        ...
        {
            npc_alysrazor_molten_meteorAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
                me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_STUN, true);
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return new npc_alysrazor_molten_meteorAI(creature);
        }
};
